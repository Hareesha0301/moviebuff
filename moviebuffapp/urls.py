...
urlpatterns = [
    ...
    path('movies/<int:id>/reviews', views.ReviewView.as_view(), name='all_review'),
    ...
    path('deletereview/<int:id>', views.DeleteReviewView.as_view(), name='delete_review'),
    path('loginuserdetail/<int:id>', views.LoginUserView.as_view(), name='login_user'),
]
